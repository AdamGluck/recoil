...
- (IBAction)contactOrganizer:(id)sender {
    if (self.organizationContact.length != 0){
        ...
        [controller setMessageBody:@"Hello, \n I found out about your organization through an app called Recoil.  I am passionate about helping to stop violence and want to help out.  Let me know anyway I can help contribute to your organization!" isHTML:NO];
